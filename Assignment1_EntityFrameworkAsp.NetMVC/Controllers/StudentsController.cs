...
namespace Assignment1_EntityFrameworkAsp.NetMVC.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,Name,Gender,CourseId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,Name,Gender,CourseId")] Student student)
        {
            if (ModelState.IsValid)
            {
